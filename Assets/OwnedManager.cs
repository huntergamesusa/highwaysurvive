...
public class OwnedManager : MonoBehaviour, IStoreListener {
	...
	public static void ReceiveAvailableItems(List<string> available){
		myDataModel.availableItems = available;
